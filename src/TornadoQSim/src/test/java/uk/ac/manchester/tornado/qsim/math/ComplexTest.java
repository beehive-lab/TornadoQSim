...
public class ComplexTest {
    ...
    public void testComplexArithmetics() {
        Complex a = new Complex(-4.5, 8);
        Complex b = new Complex(10.5, -4);
        ...
        assertEquals(new Complex(-15.25, 102), a.times(b));
        assertEquals(new Complex(-15.25, 102), b.times(a));

        a = new Complex(20, 4);
        b = new Complex(10, 2);
        assertEquals(new Complex(2, 0), a.div(b));
        assertEquals(new Complex(0.5, 0), b.div(a));
    ...
    public void testComplexEquality() {
        ...
        Complex c = new Complex(-4.5, 0);
        assertNotEquals(a, c);
    }

    @Test
    public void testComplexString() {
        assertEquals(new Complex(-4.5, 0).toString(), "-4.5");
        assertEquals(new Complex(0, 4.5).toString(), "4.5i");
        assertEquals(new Complex(0, -4.5).toString(), "-4.5i");
        assertEquals(new Complex(8, -4.5).toString(), "8.0 - 4.5i");
        assertEquals(new Complex(8, 4.5).toString(), "8.0 + 4.5i");
    }
