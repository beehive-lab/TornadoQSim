...
public class FsvSimulatorStandardTest {
    ...
    public void testBellState() {
        Circuit circuit;
        State state;
        Simulator fsvSimulator = new FsvSimulatorStandard();

        // Test Bell state qubits: 0-1
        circuit = new Circuit(3);
        circuit.H(0);
        circuit.CNOT(0,1);
        state = fsvSimulator.simulateFullState(circuit);
    ...
    public void testRandomCircuit() {
        ...
        State state = fsvSimulator.simulateFullState(circuit);
